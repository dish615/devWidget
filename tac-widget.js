    ...
    jQuery(document).ready(function($) { 
        ...
        */
        ...
        var css_link = $("<link>", { 
            rel: "stylesheet", 
            type: "text/css", 
            href: "https://cdn.rawgit.com/dish615/devWidget13/master/style.css" 
       ...
       var widg_script = $("<script>", {
           type: "text/javascript",
            async: true,
            src: "https://cdn.rawgit.com/dish615/devWidget13/master/check.js"
        });
        ...
        var jsonp_url= "https://cdn.rawgit.com/dish615/devWidget13/master/index.html";
        $.get(jsonp_url, function(data){
           ...
           // console.log($("#plzwork"));
            document.getElementById("plzwork").postMessage(stored, web);  
